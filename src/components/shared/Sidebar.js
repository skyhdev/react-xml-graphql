        ...
        return (
            <Navbar inverse={true.toString()} className="sidebarMenu sidebarMenuToggle">
                ...
                <div className="d-flex flex-column w-100">
                    ...
                    {data.map((link) => {
                        return (
                            <div className={"p-2 mb-1 sidebarLink " + (props.active == link.name ? "active" : "")} key={link.name + "_toggle"}>
                                <Link className="d-flex items-center align-items-center linkTag" to={link.link}>
                                    <span>{link.icon}</span>
                    ...
                    <div className="p-2 mb-1 logout sidebarLink" onClick={logout} key={"logout_toggle"}>
        ...
        return (
            <Navbar inverse={true.toString()} className="sidebarMenu">
                <div className="d-flex flex-column w-100">
                    ...
                    {data.map((link) => {
                        return (
                            <div className={"p-2 mb-1 text-center sidebarLink " + (props.active == link.name ? "active" : "")} key={link.name}>
                                <Link to={link.link}>
                                    <span>{link.icon}</span>
                                </Link>
                            </div>
                    ...
                    <div className="p-2 mb-1 text-center logout sidebarLink" onClick={logout} key="logout">
                        <div>
                            <span><RiIcon.RiLogoutCircleLine className="linkIcon" /></span>
                        </div>
                    </div>
